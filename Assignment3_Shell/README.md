...
Cat Smith - helped with stripping newline from array of strings
- Did you use any external resources? (Cite them below)
  - https://www.ibm.com/support/knowledgecenter/en/SSLTBW_2.3.0/com.ibm.zos.v2r3.bpxbd00/rtgtc.htm
  - https://stackoverflow.com/questions/5636590/moving-up-a-directory
  - https://www.tutorialspoint.com/c_standard_library/c_function_scanf.htm
  - https://stackoverflow.com/questions/9210528/split-string-with-delimiters-in-c
  - https://stackoverflow.com/questions/822323/how-to-generate-a-random-int-in-c
  - https://www.tutorialspoint.com/c_standard_library/c_function_scanf.htm
  - multiple geeksforgeeks, stackover, tutorialspoint
- (Optional) What was your favorite part of the assignment?
    - designing the array to create a semi-hashmap was a good exercise
    - string parsing in C is a lot but good to learn.
...
Mods of Rando Numbers

SYNOPSIS: 

Players Start with 23 Points, a random number is generated each round, they must guess if it's divisble by 2, 3, 7, 11, and win/lose corresponding bet. Game ends at 0 with a loss, or 40 points with win.


DESCRIPTION:

A random number is generated each round. A player starts with 23 points. A player guesses if the random number is divisible by 2, 3, 7, or 11. 
By 2 - 1 points.
By 3 - 3 points.
By 7 - 10 points.
By 11 - 22 points.

The player loses or gains the amount of points for a wrong or right guess.

Example of game play:

Round 1: 
Points: 23
(Background, not shown to player, random number gen'd: 292103203022)
`Guess> 2`
New Points: 24 (plus 1)

Round 2: 
Points: 24
(Backgroudn random: 3224343411)
`Guess> 2`
New Points: 23 (minus 1)
...
-Game play is a while loop.

-Random number is generated with:
`srand(time(NULL)); int rng = rand()`

- input is taken w/ `scanf()`


-Player guess is compared to series of if statements, such as:
