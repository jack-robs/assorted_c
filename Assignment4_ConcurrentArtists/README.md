...
- Did you collaborate with any other students/TAs/Professors?
	- Catherine Smith: discussed why to malloc in the painter
...
If an artist's starting position is a pixel that's already been painted around all sides, it wouldn't have a white pixel to paint, and would get constantly sent back to it's starting position. The same would occur if a lock failed
...
- Stanford Essential C Pointers review
- Fork() chapters in OSTEP.
...
- Stanford Essential C - Pointers is a second PDF that goes into pointers more deeply, and is referenced by Essential C. I reviewed the nuances b/t character pointer arrays, vs. character arrays, passing arrays to functions, pointers of pointers, etc. I was getting tripped up on this/had to review.

- OSTEP: I didn't read Ch 4/5 in this, so caught up specifically on the processes API.
