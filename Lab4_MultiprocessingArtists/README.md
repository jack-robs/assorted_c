...
There are 12 cpu cores available on 30+ machines.
```
cpu cores	: 12
```
...
I'm not getting any memleaks currently but will continue to reasses:

```
parent is exiting
--117227-- REDIR: 0x4ebceb0 (libc.so.6:free) redirected to 0x4c2af16 (free)
==117227== 
==117227== HEAP SUMMARY:
==117227==     in use at exit: 0 bytes in 0 blocks
==117227==   total heap usage: 1 allocs, 1 frees, 32,000 bytes allocated
==117227== 
==117227== All heap blocks were freed -- no leaks are possible
==117227== 
==117227== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
==117227== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
```
...
fork makes a complete copy of the fork caller's data space, while vfork just borrows memory and thread control until execve or exit occurs, while parent process stays suspended.
